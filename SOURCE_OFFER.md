...
exact revisions and these build scripts. Prebuilt compilers/libraries are restored
from the recorded AOSP manifest. Their upstream license files remain in their
